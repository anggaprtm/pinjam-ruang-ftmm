        ...
        <form method="POST" action="{{ route("admin.kegiatan.update", [$kegiatan->id]) }}" enctype="multipart/form-data">
            ...
            @if(auth()->user()->isAdmin())
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control {{ $errors->has('sik_application_id') ? 'is-invalid' : '' }}" type="number" min="1" name="sik_application_id" id="sik_application_id_admin" value="{{ old('sik_application_id', $kegiatan->sik_application_id) }}" placeholder="Isi ID SIK jika tersedia">
                ...
                <div class="form-group mb-3 d-none" id="override-reason-wrapper">
                    ...
                    <textarea class="form-control {{ $errors->has('override_reason') ? 'is-invalid' : '' }}" name="override_reason" id="override_reason" rows="2" placeholder="Jelaskan alasan override...">{{ old('override_reason', $kegiatan->override_reason) }}</textarea>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control {{ $errors->has('sik_application_id') ? 'is-invalid' : '' }}" name="sik_application_id" id="sik_application_id" required>
                        ...
                        @foreach(($sikApplications ?? collect()) as $sik)
                            <option value="{{ $sik->id }}" {{ (old('sik_application_id', $kegiatan->sik_application_id) == $sik->id) ? 'selected' : '' }}>
