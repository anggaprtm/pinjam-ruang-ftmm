        ...
        <form method="POST" action="{{ route("admin.jadwal-perkuliahan.update", [$jadwalPerkuliahan->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label required" for="program_studi">Kelas / Prodi</label>
                        <input class="form-control {{ $errors->has('program_studi') ? 'is-invalid' : '' }}" 
                            type="text" 
                            name="program_studi" 
                            id="program_studi" 
                            value="{{ old('program_studi', $jadwalPerkuliahan->program_studi) }}" 
                            placeholder="Cth: TE-A1" 
                            required>
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label" for="dosen">Dosen Pengampu (Opsional)</label>
                        <input class="form-control {{ $errors->has('dosen') ? 'is-invalid' : '' }}" type="text" name="dosen" id="dosen" value="{{ old('dosen', $jadwalPerkuliahan->dosen) }}" placeholder="Kosongkan jika tidak ada">
                        @if($errors->has('dosen'))
                            <div class="invalid-feedback">{{ $errors->first('dosen') }}</div>
                        @endif
                    </div>
